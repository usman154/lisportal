...
export class ContactsService
{
    ...
    public userEvents: EventEmitter<any> = new EventEmitter();
    /**
     * Constructor
     */
     ...
     */
     getUsers(): Promise<any> {
        return new Promise((resolve, reject) => {
            this._httpClient.get((<any>window).appBaseUrl + `/users`)
    ...
    createLocation(data): Promise<any> {
        return new Promise((resolve, reject) => {
            this._httpClient.post((<any>window).appBaseUrl + `/locations`, {...data})
                .subscribe((response: any) => {
                    resolve(response);
                }, reject);
        });
    ...
    getLocations(): Promise<any> {
        return new Promise((resolve, reject) => {
            this._httpClient.get((<any>window).appBaseUrl + `/locations`)
                .subscribe((response: any) => {
                    resolve(response);
                }, reject);
        });
    ...
    getContactDetails(id):Promise<any> {
        return new Promise((resolve, reject) => {
            this._httpClient.get((<any>window).appBaseUrl + `/users/${id}`)
                .subscribe((response: any) => {
                    resolve(response);
                }, reject);
        });
    ...
    registerUser(data):Promise<any> {
        return new Promise((resolve, reject) => {
            this._httpClient.post((<any>window).appBaseUrl + `/users/register`, data)
                .subscribe((response: any) => {
                    resolve(response);
                    this.userEvents.emit({type: 'added', data: response})
                }, reject);
        });
    }
    updateUser(data, id):Promise<any> {
        return new Promise((resolve, reject) => {
            this._httpClient.put((<any>window).appBaseUrl + `/users/${id}`, data)
                .subscribe((response: any) => {
                    resolve(response);
                    this.userEvents.emit({type: 'updated', data: response})
                }, reject);
        });
    }
    deleteUser( id):Promise<any> {
        return new Promise((resolve, reject) => {
            this._httpClient.delete((<any>window).appBaseUrl + `/users/${id}`)
                .subscribe((response: any) => {
                    resolve(response);
                    this.userEvents.emit({type: 'deleted', data: {id: id}})
                }, reject);
        });
    }
