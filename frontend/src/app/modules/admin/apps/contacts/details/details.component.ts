...
export class ContactsDetailsComponent implements OnInit, OnDestroy
{
    ...
    async ngOnInit()
    {
        ...
        this.contact = await this._formsService.getFormData(params.id);
     ...
     * Update the contact
     */
     resultSelectedUpdated(){
        this.contact.report_status = 'reported';
        const cdt = moment();
        const reported_date = cdt.format('MM/DD/YYYY HH:mm A')
        this.contact.reported_date = reported_date;
     }
    async updateContact()
    {
        
        await this._formsService.updateFormResults(this.contact_id, this.contact);
        this.toggleEditMode(false);
    }
    async sendEmail(){
        await this._formsService.sendReportEmail(this.contact);
        this._snackBar.open(`Report sent to ${this.contact.email}`, 'Done');
    }
