...
export const appRoutes: Route[] = [
    ...
    {path: '', pathMatch : 'full', redirectTo: 'apps/contacts'},
    ...
    {path: 'signed-in-redirect', pathMatch : 'full', redirectTo: 'apps/contacts'},
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'apps', children: [
                ...
                {path: 'users', loadChildren: () => import('app/modules/admin/apps/users/contacts.module').then(m => m.UsersModule)},
